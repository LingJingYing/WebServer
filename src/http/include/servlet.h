#ifndef __LJY_SERVLET_H__
#define __LJY_SERVLET_H__
...
public:
    ...
    virtual int32_t handle(ljy::http::HttpRequest::ptr request
                   ...
                   , ljy::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (ljy::http::HttpRequest::ptr request
                   , ljy::http::HttpResponse::ptr response
                   , ljy::http::HttpSession::ptr session)> callback;
