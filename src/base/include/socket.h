#ifndef __LJY__SOCKET_H__
#define __LJY__SOCKET_H__
...
public:
    ...
    static Socket::ptr CreateTCP(ljy::Address::ptr address);

    static Socket::ptr CreateUDP(ljy::Address::ptr address);
...
public:
    ...
    static SSLSocket::ptr CreateTCP(ljy::Address::ptr address);
