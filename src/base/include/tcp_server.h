#ifndef __LJY_TCP_SERVER_H__
#define __LJY_TCP_SERVER_H__
...
public:
     ...
     */
    TcpServer(ljy::IOManager* worker = ljy::IOManager::GetCurrentScheduler()
              ,ljy::IOManager* io_woker = ljy::IOManager::GetCurrentScheduler()
              ,ljy::IOManager* accept_worker = ljy::IOManager::GetCurrentScheduler());
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(ljy::Address::ptr addr, bool ssl = false);
